...
HD_PWD='C:/Users/Darius/Desktop/Y4S1/EE4218/lab1/lab1.runs/zynq_design_1_axi_bram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_1_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_1_axi_bram_ctrl_0_bram_0.tcl
