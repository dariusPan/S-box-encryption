...
#
# Generated by export_simulation on Tue Sep 05 17:41:05 +0800 2017
#
################################################################################
...
switch to the './zynq_design_1.sh' script.

./zynq_design_1.sh -reset_run
...
./zynq_design_1.sh -noclean_files

For more information on the script, please type './zynq_design_1.sh -help'.
